...
class ProductDetail extends Component {
  ...
  handleSubmit = (_comment, updatedRating) => {
    ...
    fetch(`${API}/place/${this.state.placeinfo.place_id}/ratings`, {
      method: "POST",
      headers: { Authorization: localStorage.getItem("token") },
      body: JSON.stringify({
      ...
      .then((res) => res.json())
      .then((res) => {
        console.log(res, "댓글 추가 후 백에서 받는 결과");
  ...
  handleDelete = (id) => {
    console.log(this.state.ratings, id, "비교!!!!");
    console.log("handle delete");
    fetch(`${API}/place/rating/${id}`, {
      method: "DELETE",
      headers: {
      ...
      .then((res) => res.json())
      .then((res) => {
        console.log(res, "delete 결과");
        const filteredComments = this.state.ratings.filter(
          (comment) => comment.id !== res.deleted_rating_id
        );
        console.log(filteredComments, "delete 후 로컬 delete");
        this.setState({
          ...
          <section className="product-detail-content-container">
              ...
              <div className="left">
                ...
                <div className="left-desc">
                  <div className="left-desc-content">
                    <br /> <br />
                    <br /> 집은 작지만 앞 뒤 베란다, 북한산뷰가 예뻐요.아파트
                    바로 앞이 북한산 둘레길과 연결되어 있습니다. <br /> 비가
                    내리면 운무가 그윽하고 볕이 나는 날엔 선셋도
                    대단합니다.주방에서 보이는 북한산 뷰포인트가 최애공간이에요!
                    <br />
                    <br />
                  </div>{" "}
            ...
            <div className="product-detail-info-another">
              ...
              <div className="product-detail-another-place">
                <div className="product-detail-another-place-header"></div>{" "}
